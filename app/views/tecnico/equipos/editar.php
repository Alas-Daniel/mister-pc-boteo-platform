...
<body class="vh-100 d-flex flex-column">
    ...
    <div class="flex-grow-1 d-flex flex-column flex-md-row" style="min-height: 0;">
        ...
        <main class="flex-grow-1 overflow-auto p-4">
            <h4 class="text-center mb-4 fw-bold">ACTUALIZAR INFORMACIÓN Y EQUIPO</h4>
            ...
            <div class="border p-4 rounded">
                ...
                <form method="POST" action="<?= BASE_URL ?>tecnico/equipos/update/<?= $equipo['id'] ?>">
                    <!-- Campo oculto con el ID del equipo -->
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4">
                            ...
                            <select name="cliente_id" class="form-select" disabled>
                                <option value="<?= $equipo['cliente_id'] ?>">
